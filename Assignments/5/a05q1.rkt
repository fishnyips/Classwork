...
;; Examples:
(check-expect (execution-score (cons 6 (cons 5 (cons 9 (cons 2 empty))))) 5.5)
(check-expect (execution-score (cons 10 (cons 1 (cons 10 (cons 4 (cons 7 empty)))))) 7)

(define (execution-score scores)
  (averageoflist (sum-adjusted (adjusted-list scores)) (adjusted-list scores)))

;; Tests:
(check-expect (execution-score (cons 0 (cons 0 (cons 0 (cons 0 (cons 0 empty)))))) 0)
(check-expect (execution-score (cons 10 (cons 10 (cons 10 (cons 10 (cons 10 empty)))))) 10)
